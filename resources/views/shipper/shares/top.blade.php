    ...
    <div class="navbar-header d-xl-block d-none">
      <ul class="nav navbar-nav">
        <li class="nav-item"><a class="navbar-brand" href="/assets_admin/html/ltr/horizontal-menu-template/index.html"><span class="brand-logo">
            ...
            <h2 class="brand-text mb-0">Trang Shipper</h2></a></li>
      </ul>
    </div>
      ...
      <ul class="nav navbar-nav align-items-center ml-auto">
        ...
        <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none">
                ...
                <span class="user-status">Shipper</span>
            </div>
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
            ...
            <a class="dropdown-item" href="/shipper/logout"><i class="mr-50" data-feather="power"></i> Logout</a>
            @endif
          </div>
        </li>
      </ul>
