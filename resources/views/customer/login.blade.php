                                    ...
                                    <form class="mx-1 mx-md-4" autocomplete="off">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-2">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <label style="margin-left: 120px"><a style="color: black" href="/forgot"><b>Quên mật khẩu</b></a></label>
                                            </div>
                                        </div>
                                        <div>
                                            <label>Bạn có mật khẩu chưa ???</label><a href="/cafe/customer/register"><b>Register</b></a>
                                        </div>
                                        {{-- <div class="d-flex justify-content-end mx-4 mb-3 mb-lg-4">
                                            <button style="margin-right: 90px" id="login" type="button"
                                                class="btn btn-dark btn-lg">Login
                                            </button>
                                        </div>
                                        <div class="d-flex justify-content-end mx-4 mb-3 mb-lg-4">
                                            <button style="margin-right: 90px;g" id="login" type="button"
                                                class="btn btn-dark btn-lg">Google +
                                            </button>
                                        </div> --}}
                                        <div class="d-flex justify-content-end mx-4 mb-3 mb-lg-4" style="text-align: center">
                                            <button style="width: 100px;" id="login" type="button" class="btn btn-dark ">Login</button>
                                            <div style="width: 150px;">
                                                <a href="/login-google"  class="btn btn-danger " type="submit">GOOGLE +</a>
                                            </div>
                                        </div>
                ...
                $.ajax({
                    ...
                    success :   function(res) {
                        if(res.status == 1) {
                            ...
                            setTimeout(function(){
                                $(location).attr('href','http://127.0.0.1:8000/cafe/homepage');
                            }, 2000);

                        } else if(res.status == 2) {
                            toastr.warning("email chưa kích hoạt");
                        }
