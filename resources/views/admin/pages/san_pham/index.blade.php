...
@section('content')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-prepend">
                                      <a type="button" data-input="anh_dai_dien" data-preview="holder" class="btn btn-primary lfm" value="Upload">
    ...
    <div class="col-md-12">
        <div class="table-response">
            <div class="main-card mb-3 card">
                <div style="overflow-x: scroll;" class="card-body"><h5 class="card-title">Table bordered</h5>
