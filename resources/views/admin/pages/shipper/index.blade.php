...
<div style="text-align: center">
    <h3>Quản Lý Tài Khoản Shipper</h3>
</div>
@endsection
@section('content')
    <div class="row">
...
$(document).ready(function() {
    ...
    function loadTable(){
        $.ajax({
                url     :   '/admin/shipper/dulieu',
                type    :   'get',
            success :   function(res) {
                    var content_table = '';
                    $.each(res.dulieuShipper, function(key, value) {
                    if(value.is_open) {
    ...
    $('body').on('click','.doiTrangThai',function(){
            ...
            var self = $(this);
            $.ajax({
                url     :     '/admin/shipper/doi-trang-thai/' + idUser,
                type    :     'get',
                success :     function(res) {
                    if(res.trangThai) {
