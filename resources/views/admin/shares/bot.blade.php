    ...
    <script src="/assets_admin/app-assets/vendors/js/charts/apexcharts.min.js"></script>
    <script src="/assets_admin/app-assets/vendors/js/extensions/toastr.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="/assets_admin/app-assets/js/scripts/pages/dashboard-ecommerce.min.js"></script>
    <!-- END: Page JS-->
